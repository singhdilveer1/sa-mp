...
$exclude = array( '.', '..', '.DS_Store', 'reader','index.php', '.git', '.gitmodules', '.gitignore', 'node_modules' );
...
if ( !empty( $files ) ) {
    ...
    foreach ( $files as $file ) {
        ...
        // show the file
        print '<a href="https://sa-mp.pikko.xyz/files/' . $file . '"><li class="' . ext( $file ) . '">' . $file . ( !is_dir( $file ) ? ' <span>' . human_filesize( $file ) . '</span>' : '' ) . '</li></a>';
...
?></div></body><center><font color="red">Thanks <a href="https://github.com/KrustyKoyle">KrustyKoyle</a> and <a href="https://www.open.mp/">open.mp</a> for their contributions in keeping the SA-MP legacy alive.</font></center></html>